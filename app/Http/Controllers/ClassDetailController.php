...
class ClassDetailController extends Controller
{
    ...
    public function viewClassDetails($id){
        return view('students.index',[
            'classDetails' => ClassDetail::select('user.user_id as studentId', 'user.name as studentName', 'user.user_code as nisn', 'class_detail.class_detail_id as classDetailId',
